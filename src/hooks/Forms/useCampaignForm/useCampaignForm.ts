...
export const campaignIncludes = 'compendium;notebook;quests;quests.type;quests.parent;encounters;encounters.type;sessions;pins;pins.pinnable;users;users.pins;users.pins.pinnable;gameMaster';
