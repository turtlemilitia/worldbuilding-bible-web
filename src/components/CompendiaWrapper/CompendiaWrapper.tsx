...
const CompendiaWrapper: FunctionComponent<TCompendiaWrapperProps> = (): JSX.Element => {
  ...
  const includes = 'notebook;characters;concepts;currencies;deities;factions;items;languages;locations;locations.parent;naturalResources;pantheons;planes;religions;species;spells;stories'
